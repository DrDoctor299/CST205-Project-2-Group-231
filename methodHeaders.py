...
def generatePlaylist(keyword):
	for song in musicList:
		if keyword is 'dance':
			if checkDance(song) = True:
				addtoList(song)
		else if keyword is 'energy':
			if checkEnergy(song) = True:
				addtoList(song)
		else if keyword is 'loudness':
			if checkLoudness(song) = True:
				addtoList(song)
			
		else if keyword is 'speech':
			if checkSpeech(song) = True:
				addtoList(song)
		
		else if keyword is 'acoustic':
			if checkAcoustic(song) = True:
				addtoList(song)
		
		else if keyword is 'instrumental':
			if checkInstrumental(song) = True:
				addtoList(song)
			
		else if keyword is 'liveness':
			if checkLiveness(song) = True:
				addtoList(song)
			
		else if keyword is 'tempo':
			if checkTempo(song) = True:
				addtoList(song)
